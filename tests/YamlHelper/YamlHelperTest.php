...
namespace jeslopcru\SimplySlug\tests\YamlHelperTest;
...
class YamlHelperTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testArrayToYamlSpecialCharts()
    {
        $fileYml = __DIR__ . '/../../src/charMap.yml';
        file_put_contents($fileYml, yaml_emit(YamlHelperTest::$charMap));
